  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center animate-in fade-in zoom-in duration-500">
      ...
      <p className="text-xl text-gray-400 max-w-xl mb-8">
        Your AdSpot 2.0 workspace has been created, your pixel is active, and your campaign data is
        synced.
      </p>
      ...
      <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-6 max-w-md w-full mb-8 text-left">
        ...
        <ul className="space-y-3">
          <li className="flex items-start gap-3">
            <div className="w-6 h-6 rounded-full bg-red-900/30 flex items-center justify-center shrink-0 text-xs font-bold text-red-500">
              1
            </div>
          ...
          <li className="flex items-start gap-3">
            ...
            <span className="text-gray-300 text-sm">
              Install the tracking pixel if you haven&apos;t already.
            </span>
          </li>
          <li className="flex items-start gap-3">
            <div className="w-6 h-6 rounded-full bg-red-900/30 flex items-center justify-center shrink-0 text-xs font-bold text-red-500">
