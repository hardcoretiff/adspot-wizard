...
import { Copy, Check, Code, Info, MousePointer2, Target, Activity, Eye, HelpCircle, PlayCircle } from 'lucide-react';
...
const Tooltip: React.FC<{ content: string }> = ({ content }) => (
  <div className="group relative inline-block ml-2 align-middle z-50">
    <HelpCircle size={15} className="text-gray-500 hover:text-red-500 cursor-help transition-colors" />
    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="space-y-2 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-400">Install your snippets to capture audience data and user behavior.</p>
        </div>
            ...
            <div className="flex items-center justify-between px-4 py-3 border-b border-neutral-800 bg-neutral-950 rounded-t-xl">
              <div className="flex items-center gap-2 relative z-10">
                ...
                <span className="text-sm font-medium text-gray-300">
                  {activeTab === 'pixel' ? 'Pixel Installation Script' : 'Heatmap Installation Script'}
                </span>
                <Tooltip 
                  content={activeTab === 'pixel' 
          ...
          <div className="bg-blue-900/10 border border-blue-900/30 rounded-xl p-5 flex gap-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-blue-200/70 leading-relaxed">
                Copy the code above and paste it into the <code className="bg-blue-900/30 px-1.5 py-0.5 rounded text-blue-100 text-xs">&lt;head&gt;</code> section of every page on your website.
                {activeTab === 'pixel' 
        ...
        <div className="space-y-6">
            <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-6">
                <div className="flex items-center mb-4">
                  ...
                  <Tooltip content={activeTab === 'pixel' ? "Without a pixel, you can't track who visited your site or if your ads resulted in sales." : "Heatmaps take the guesswork out of design by showing you what users actually look at."} />
                </div>
